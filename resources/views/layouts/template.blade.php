                            ...
                            <ul class="mega-dropdown-menu dropdown-menu row">
                                <li class="col-md-2 col-sm-6">
                                    ...
                                    <div id="mega-menu-carousel-example">
                                        <div><img class="rounded img-fluid mb-1" src="{{ asset('admins/asset/app-assets/images/slider/slider-2.png')}}" alt="First slide"><a class="news-title mb-0 d-block" href="#">Poster Frame PSD</a>
                                ...
                                <li class="col-md-3 col-sm-6">
                                    ...
                                    <ul>
                                        <li class="menu-list">
                                            <ul>
                                                <li><a class="dropdown-item" href="{{asset('admins/html/ltr/template/verticallayout-fixed.html')}}"><i class="ft-file"></i> Page layouts</a></li>
                                                <li><a class="dropdown-item" href="{{asset('admins/html/ltr/template/color-palette-primary.html')}}"><i class="ft-camera"></i> Color pallet</a></li>
                                                <li><a class="dropdown-item" href="{{asset('admins/asset/starter-kit/ltr/vertical-menu-template/layout-static.html')}}"><i class="ft-edit"></i> Starter kit</a></li>
                                                <li><a class="dropdown-item" href="{{asset('admins/html/ltr/template/changelog.html')}}"><i class="ft-minimize-2"></i> Change log</a></li>
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-mail"></i><span class="badge badge-pill badge-warning badge-up">3</span></a>
                            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                ...
                                <li class="scrollable-container media-list"><a href="javascript:void(0)">
                                        <div class="media">
                                            <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{asset('admins/asset/app-assets/images/portrait/small/avatar-s-1.png')}}" alt="avatar"><i></i></span></div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="media-left"><span class="avatar avatar-sm avatar-busy rounded-circle"><img src="{{asset('admins/asset/app-assets/images/portrait/small/avatar-s-2.png')}}" alt="avatar"><i></i></span></div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{asset('admins/asset/app-assets/images/portrait/small/avatar-s-3.png')}}" alt="avatar"><i></i></span></div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="media-left"><span class="avatar avatar-sm avatar-away rounded-circle"><img src="{{asset('admins/asset/app-assets/images/portrait/small/avatar-s-6.png')}}" alt="avatar"><i></i></span></div>
                                            <div class="media-body">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="avatar avatar-online"><img src="{{asset('admins/asset/app-assets/images/portrait/small/avatar-s-1.png')}}" alt="avatar"><i></i></span><span class="user-name">John Doe</span></a>
...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="{{@url('/admin')}}"><i class="ft-home"></i><span class="menu-title" data-i18n="">Dashboard</span><span class="badge badge badge-primary badge-pill float-right mr-2">3</span></a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{asset('admins/html/ltr/template/dashboard-ecommerce.html')}}">eCommerce</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/dashboard-analytics.html')}}">Analytics</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/dashboard-fitness.html')}}">Fitness</a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item"><a href="#"><i class="ft-zap"></i><span class="menu-title" data-i18n="">Starter kit</span><span class="badge badge badge-danger badge-pill float-right mr-2">New</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{asset('admins/asset/starter-kit/ltr/template/layout-1-column.html')}}">1 column</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/asset/starter-kit/ltr/template/layout-2-columns.html')}}">2 columns</a>
                    </li>
                    <li><a class="menu-item" href="#">Content Det. Sidebar</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{asset('admins/asset/starter-kit/ltr/template/layout-content-detached-left-sidebar.html')}}">Detached left sidebar</a>
                            </li>
                            <li><a class="menu-item" href="{{asset('admins/asset/starter-kit/ltr/template/layout-content-detached-left-sticky-sidebar.html')}}">Detached sticky left sidebar</a>
                            </li>
                            <li><a class="menu-item" href="{{asset('admins/asset/starter-kit/ltr/template/layout-content-detached-right-sidebar.html')}}">Detached right sidebar</a>
                            </li>
                            <li><a class="menu-item" href="{{asset('admins/asset/starter-kit/ltr/template/layout-content-detached-right-sticky-sidebar.html')}}">Detached sticky right sidebar</a>
                            </li>
                        </ul>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item" href="{{asset('admins/asset/starter-kit/ltr/template/layout-fixed-navbar.html')}}">Fixed navbar</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/asset/starter-kit/ltr/template/layout-fixed-navigation.html')}}">Fixed navigation</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/asset/starter-kit/ltr/template/layout-fixed-navbar-navigation.html')}}">Fixed navbar &amp; navigation</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/asset/starter-kit/ltr/template/layout-fixed-navbar-footer.html')}}">Fixed navbar &amp; footer</a>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item" href="{{asset('admins/asset/starter-kit/ltr/template/layout-fixed.html')}}">Fixed layout</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/asset/starter-kit/ltr/template/layout-boxed.html')}}">Boxed layout</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/asset/starter-kit/ltr/template/layout-static.html')}}">Static layout</a>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item" href="{{asset('admins/asset/starter-kit/ltr/template/layout-light.html')}}">Light layout</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/asset/starter-kit/ltr/template/layout-dark.html')}}">Dark layout</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/asset/starter-kit/ltr/template/layout-semi-dark.html')}}">Semi dark layout</a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item"><a href="{{asset('admins/html/ltr/template/app-email.html')}}"><i class="ft-mail"></i><span class="menu-title" data-i18n="">Email Application</span></a>
            </li>
            <li class=" nav-item"><a href="{{asset('admins/html/ltr/template/app-chat.html')}}"><i class="ft-message-square"></i><span class="menu-title" data-i18n="">Chat Application</span></a>
            </li>
            <li class=" nav-item"><a href="{{asset('admins/html/ltr/template/app-todo.html')}}"><i class="ft-check-square"></i><span class="menu-title" data-i18n="">Todo Application</span></a>
            </li>
            <li class=" nav-item"><a href="{{asset('admins/html/ltr/template/app-contacts.html')}}"><i class="ft-users"></i><span class="menu-title" data-i18n="">Contacts</span></a>
            </li>
            <li class=" nav-item"><a href="{{asset('admins/html/ltr/template/project-summary.html')}}"><i class="ft-airplay"></i><span class="menu-title" data-i18n="">Project Summary</span></a>
            </li>
            <li class=" nav-item"><a href="{{asset('admins/html/ltr/template/invoice-template.html')}}"><i class="ft-printer"></i><span class="menu-title" data-i18n="">Invoice Template</span></a>
            </li>
            <li class=" nav-item"><a href="#"><i class="ft-share"></i><span class="menu-title" data-i18n="">Timelines</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/timeline-center.html')}}">Timelines Center</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/timeline-horizontal.html')}}">Timelines Horizontal</a>
                    </li>
                </ul>
            </li>
            <li class=" nav-item"><a href="#"><i class="ft-user"></i><span class="menu-title" data-i18n="">Users</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/user-profile.html')}}">Users Profile</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/user-cards.html')}}">Users Cards</a>
                    </li>
                </ul>
            </li>
            <li class=" nav-item"><a href="#"><i class="ft-plus-square"></i><span class="menu-title" data-i18n="">Calender</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/full-calender-basic.html')}}">Full Calender Basic</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/full-calender-events.html')}}">Full Calender Events</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/full-calender-advance.html')}}">Full Calender Advance</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/full-calender-extra.html')}}">Full Calender Extra</a>
                    </li>
                </ul>
            </li>
            <li class=" nav-item"><a href="#"><i class="ft-image"></i><span class="menu-title" data-i18n="">Gallery</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/gallery-grid.html')}}">Gallery Grid</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/gallery-grid-with-desc.html')}}">Gallery Grid with Desc</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/gallery-masonry.html')}}">Masonry Gallery</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/gallery-masonry-with-desc.html')}}">Masonry Gallery with Desc</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/gallery-hover-effects.html')}}">Hover Effects</a>
                    </li>
                </ul>
            </li>
            <li class=" nav-item"><a href="#"><i class="ft-search"></i><span class="menu-title" data-i18n="">Search</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/search-page.html')}}">Search Page</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/search-website.html')}}">Search Website</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/search-images.html')}}">Search Images</a>
                    </li>
                    <li><a class="menu-item" href="{{asset('admins/html/ltr/template/search-videos.html')}}">Search Videos</a>
                    </li>
                </ul>
            </li>

                                    ...
                                    <div class="carousel-inner">
                                            ...
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="card text-center">
                                                    <div class="card-header">
                                                        <h4 class="card-title">Project 1</h4><a href="#"><i class="far fa-trash-alt danger"> DELETE</i></a>
                                                        <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3 danger"></i></a>
                                        ...
                                        <div class="carousel-item">
                                            ...
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="card text-center">
                                                    <div class="card-header">
                                                        <h4 class="card-title">Project 2</h4><a href="#"><i class="far fa-trash-alt danger"> DELETE</i></a>
                        ...
                        <div class="card-slider-item">
                            ...
                            <div class="card-footer border-top-blue-grey border-top-lighten-5 text-muted pb-3">
                                <span class="float-right">
                                    <a href="#"><i class="far fa-trash-alt danger"> DELETE</i></a>
                                </span>
                            </div>
                        </div>
                        <!-- 2 -->

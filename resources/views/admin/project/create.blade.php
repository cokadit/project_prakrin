        ...
        <div class="card">
            ...
            <div class="card-content collpase show">
                <div class="card-body">
                    ...
                    <form class="form" action="/admin/project/store" method="POST">
                        @csrf
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        <div class="form-group col-12 mb-2">
                                            ...
                                            <input type="text" id="eventRegInput1" class="form-control" placeholder="name" name="fullname" value="{{old('name')}}">
                                        </div>
                                    </div>

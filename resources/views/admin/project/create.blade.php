        ...
        <div class="card">
            ...
            <div class="card-content collpase show">
                <div class="card-body">
                    ...
                    <form class="form" action="/admin/project/store" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        <div class="form-group col-12 mb-2">
                                            ...
                                            <input type="text" id="eventRegInput1" class="form-control @error ('name') is-invalid @enderror" name="name" value="{{old('name')}}">
                                            @error('name')
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12 mb-2">
                                            ...
                                            <input type="text" id="eventRegInput2" class="form-control @error ('description') is-invalid @enderror" name="description" value="{{old('description')}}">
                                            @error('description')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
